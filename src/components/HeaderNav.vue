<template>
  <header class="bg-paper border-b border-default">
    <div class="mx-auto flex max-w-[var(--container-width)] items-center justify-between gap-3 px-4 py-3 md:gap-5">
      ...
      <div class="flex items-center gap-3 shrink-0 md:gap-4">
        <div class="flex items-center gap-2 text-left">
          <div class="flex h-8 w-8 items-center justify-center rounded-full bg-brand/10 text-brand md:h-9 md:w-9">
          ...
          <div class="leading-tight">
            ...
            <a href="tel:+5566999848877" class="text-xs font-semibold text-brand md:text-sm">(66) 99984-8877</a>
          </div>
        </div>
        <a
          href="#contato"
