      ...
      <div class="grid gap-10 md:grid-cols-[0.85fr_1.15fr] md:items-center">
        <div class="space-y-4">
          ...
          <h2 class="font-heading text-2xl font-semibold text-ink md:text-3xl">
            Fale agora com um consultor e receba acolhimento completo
          </h2>
          <p class="text-sm text-ink/80 md:text-base">
            Informe seus dados e nossa equipe entra em contato pelo WhatsApp em até 5 minutos para orientar toda a documentação e organização da cerimônia.
          </p>
          <ul class="space-y-3 text-sm text-ink/70">
            <li class="flex items-start gap-3">
              ...
              <span>Equipe presencial e digital que conduz cada etapa com você.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-brand/10 text-brand">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span>Documentação, estrutura e cerimônia resolvidas sem burocracia.</span>
            </li>
            <li class="flex items-start gap-3">
              <span class="mt-1 inline-flex h-6 w-6 items-center justify-center rounded-full bg-brand/10 text-brand">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span>Tempo médio de resposta: <strong>5 minutos</strong> via WhatsApp.</span>
            </li>
          </ul>
        </div>
        <form class="rounded-3xl border border-ink/5 bg-paper p-6 shadow-xl md:p-8" @submit.prevent="onSubmit">
          <div class="space-y-5">
            <div>
              <label class="block text-xs font-semibold uppercase tracking-wide text-ink/60">Nome completo</label>
              <input
            ...
            <div>
              <label class="block text-xs font-semibold uppercase tracking-wide text-ink/60">WhatsApp</label>
              <input
            ...
            <div>
              <label class="block text-xs font-semibold uppercase tracking-wide text-ink/60">Mensagem</label>
              <textarea
